...
export default function VerifyPage() {
  ...
  useEffect(() => {
    ...
    supabase
      .from('user_profiles')
      .select('is_verified, verification_doc_path, verification_requested_at, verification_legal_name')
      .eq('id', userProfile.id)
      .single()
      .then(({ data }) => {
        if (data?.is_verified) { setAlreadyVerified(true); return }
        ...
        <div className="card overflow-hidden">
          <div className="p-5 sm:p-6 space-y-4">
            <div>
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Look at the camera and read the phrase aloud during the 5-second recording.
              </p>
            </div>
          ...
          <div className="space-y-3">
            {([
              ...
              },
              {
                ...
                value: 'Video recorded (5 seconds)',
