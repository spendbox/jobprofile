...
export default function TalentDashboard() {
  ...
  return (
    <div className="page-container">
      ...
      {/* ── AI CV Builder card ── */}
      <Link
        href="/dashboard/talent/cv-builder"
        className="flex items-center gap-4 bg-slate-900 rounded-2xl px-5 py-4 mb-5 hover:bg-slate-800 transition-colors group"
      >
        ...
        <div className="flex-1 min-w-0">
          <p className="font-bold text-white text-sm">AI CV Builder</p>
          <p className="text-xs text-slate-400 mt-0.5">Chat with AI to create a targeted, downloadable CV in minutes</p>
        </div>
        <svg className="w-4 h-4 text-slate-500 group-hover:text-slate-300 transition-colors flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
